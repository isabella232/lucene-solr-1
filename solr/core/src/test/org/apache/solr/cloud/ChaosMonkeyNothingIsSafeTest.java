...
public class ChaosMonkeyNothingIsSafeTest extends AbstractFullDistribZkTestBase {
  ...
  public void doTest() throws Exception {
    ...
    try {
      ...
      if (runFullThrottle) {
        FullThrottleStopableIndexingThread ftIndexThread = new FullThrottleStopableIndexingThread("ft-1", true);
  ...
  class FullThrottleStopableIndexingThread extends StopableIndexingThread {
    ...
    public FullThrottleStopableIndexingThread(String id, boolean doDeletes) {
      super(id, doDeletes);
