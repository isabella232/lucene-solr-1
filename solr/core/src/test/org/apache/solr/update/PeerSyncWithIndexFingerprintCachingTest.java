...
public class PeerSyncWithIndexFingerprintCachingTest extends BaseDistributedSearchTestCase {
  ...
  IndexFingerprint getFingerprint(SolrServer client, long maxVersion) throws IOException, SolrServerException {
  ...
  void assertSync(SolrServer client, int numVersions, boolean expectedResult, String... syncWith) throws IOException, SolrServerException {
