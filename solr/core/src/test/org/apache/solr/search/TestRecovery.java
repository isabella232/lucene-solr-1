...
public class TestRecovery extends SolrTestCaseJ4 {
    ...
    public void testNewDBQAndDocMatchingOldDBQDuringLogReplay() throws Exception {
        try {
            ...
            logReplay.release(random().nextInt(6)+1);
    ...
    public void testLogReplayWithReorderedDBQ() throws Exception {
        testLogReplayWithReorderedDBQWrapper(new RunnableWithException(){public void run() throws Exception {
                ...
                new RunnableWithException(){public void run() throws Exception { assertJQ(req("q", "*:*"), "/response/numFound==2");}}
        );
    }
    ...
    public void testLogReplayWithReorderedDBQByAsterixAndChildDocs() throws Exception {
        testLogReplayWithReorderedDBQWrapper(new RunnableWithException(){public void run() throws Exception {
                ...
                new RunnableWithException(){public void run() throws Exception { assertJQ(req("q", "*:*"), "/response/numFound==6");}}
        );
    }
    ...
    public void testLogReplayWithReorderedDBQByIdAndChildDocs() throws Exception {
        testLogReplayWithReorderedDBQWrapper(new RunnableWithException(){public void run() throws Exception {
                ...
                new RunnableWithException(){public void run() throws Exception { assertJQ(req("q", "*:*"), "/response/numFound==8");}} // RDBQ3_2, RDBQ3_4 and 6 children docs (delete by id does not delete child docs)
        );
    }
    ...
    public void testLogReplayWithReorderedDBQInsertingChildnodes() throws Exception {
        testLogReplayWithReorderedDBQWrapper(new RunnableWithException(){public void run() throws Exception {
                ...
                new RunnableWithException(){public void run() throws Exception { assertJQ(req("q", "*:*"), "/response/numFound==4");}} // RDBQ4_1 and RDBQ4_2, plus 2x 3 children
        );
    }
    ...
    public void testLogReplayWithReorderedDBQUpdateWithDifferentChildCount() throws Exception {
        testLogReplayWithReorderedDBQWrapper(new RunnableWithException(){public void run() throws Exception {
                ...
                new RunnableWithException(){public void run() throws Exception { assertJQ(req("q", "*:*"), "/response/numFound==8");}} // RDBQ5_1+3children+RDBQ5_2+3children
        );
    }
