...
public class TestJsonFacets extends SolrTestCaseHS {
  ...
  public static void beforeTests() throws Exception {
    // BP JSONTestUtil.failRepeatedKeys = true;
    ...
    // BP if (Boolean.getBoolean(NUMERIC_POINTS_SYSPROP)) System.setProperty(NUMERIC_DOCVALUES_SYSPROP,"true");
  ...
  public static Iterable<Object[]> parameters() {
    ...
    for (FacetField.FacetMethod method : FacetField.FacetMethod.values()) {
      lst.add( new Object[]{method} );
    }
    return lst;
  }
  ...
  public void testMethodStream() throws Exception {
    ...
    /*** BP CDH backport doesn't have JSON merging, etc
  ...
  public static void doStatsTemplated(Client client, ModifiableSolrParams p) throws Exception {
    ...
    client.testJQ(params(p, "q", "*:*"
            , "json.facet", "{" +
                    " f0:{${terms}  type:field, field:${num_is}, limit:1}" +
  ...
  public void testOverrequest() throws Exception {
    ...
    List<SolrServer> clients = client.getClientProvider().all();
