...
public class BackupRestoreUtils extends LuceneTestCase {
  ...
  public static int indexDocs(SolrServer masterClient, String collectionName, long docsSeed) throws IOException, SolrServerException {
    ...
    masterClient.add(docs);
    masterClient.commit();
    return nDocs;
  }

  public static void verifyDocs(int nDocs, SolrServer masterClient, String collectionName) throws SolrServerException, IOException {
