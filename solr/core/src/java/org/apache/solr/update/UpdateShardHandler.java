...
public class UpdateShardHandler implements SolrMetricProducer, SolrInfoBean {
  ...
  public void initializeMetrics(SolrMetricManager manager, String registryName, String scope) {
    ...
    updateOnlyConnectionManager.initializeMetrics(manager, registryName, expandedScope);
    defaultConnectionManager.initializeMetrics(manager, registryName, expandedScope);
