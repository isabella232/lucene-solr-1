...
public class UpdateLog implements PluginInfoInitialized {
  ...
  public static class RecentUpdates {
    ...
    public RecentUpdates(int numRecordsToKeep) {
  ...
  public RecentUpdates getRecentUpdates() {
    ...
    RecentUpdates recentUpdates = new RecentUpdates(numRecordsToKeep);
   ...
   */
  public void clearLogs(SolrCore core, PluginInfo ulogPluginInfo) {
