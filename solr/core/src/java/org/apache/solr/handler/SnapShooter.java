...
public class SnapShooter {
  ...
  public SnapShooter(SolrCore core, String location, String snapshotName) {
    ...
    if (location == null) {
      ...
      snapDirStr = org.apache.solr.util.FileUtils.resolvePath(base, location).getAbsolutePath();
      File dir = new File(snapDirStr);
  ...
  public NamedList createSnapshot() throws Exception {
    ...
    try {
      ...
      if (!backupRepo.exists(snapshotDirPath)) {
        backupRepo.createDirectory(this.snapshotDirPath);
      }
      ...
      if (commitName != null) {
        ...
        IndexCommit indexCommit = deletionPolicy.getLatestCommit();
        if (indexCommit == null) {
