 ...
 * server. This property is optional and useful only in case of Active Directory
 * server.
...
public class LdapAuthenticationHandler implements AuthenticationHandler {
  ...
  private void authenticateWithTlsExtension(String userDN, String password)
    ...
    try {
      ...
      ctx.lookup(userDN);
      LOG.debug("Authentication successful for {}", userDN);
