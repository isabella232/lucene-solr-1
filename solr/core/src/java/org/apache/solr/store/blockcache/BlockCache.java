...
public class BlockCache {
  ...
  public boolean store(BlockCacheKey blockCacheKey, int blockOffset,
    ...
    BlockCacheLocation prev = cache.put(blockCacheKey.clone(), location);
    releaseLocation(blockCacheKey, prev);  // unlike Caffeine, we need to call the removal listener ourselves here.
