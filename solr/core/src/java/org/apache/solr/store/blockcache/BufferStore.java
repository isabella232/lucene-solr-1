...
public class BufferStore {
  ...
  public static void init(SolrParams params, Metrics metrics) {
    int _1024Size = params.getInt("blur.shard.buffercache.1024", 8192);
    int _8192Size = params.getInt("blur.shard.buffercache.8192", 8192);
