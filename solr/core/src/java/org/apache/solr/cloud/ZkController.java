...
public final class ZkController {
  ...
  public ZkController(final CoreContainer cc, String zkServerAddress, int zkClientTimeout, int zkClientConnectTimeout, String localHost, String locaHostPort,
      String localHostContext, String leaderVoteWait, int leaderConflictResolveWait, boolean genericCoreNodeNames, final CurrentCoreDescriptorProvider registerOnReconnect) throws InterruptedException,
 ...
 // we only put a subset of props into the leader node
  ...
  public void publish(final CoreDescriptor cd, final String state, boolean updateLastState, boolean forcePublish) throws KeeperException, InterruptedException {
    ...
    props.put(ZkStateReader.SHARD_RANGE_PROP, cd.getCloudDescriptor().getShardRange());
    props.put(ZkStateReader.SHARD_STATE_PROP, cd.getCloudDescriptor().getShardState());
