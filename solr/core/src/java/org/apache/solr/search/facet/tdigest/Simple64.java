...
public class Simple64 {
    ...
    private final long[] pending = new long[100];     // TODO -- 60 or 61 should do?
    ...
    // TODO -- need low level test that streaming api
    ...
    public int add(long v, long[] out) {
        ...
        while (inputCompressable <= inputCount) {
            ...
            if ((inputCompressable * minBits) > NUM_DATA_BITS) {
                ...
                // TODO -- it should always be > 0... right??
        ...
        */
                ...
                switch (minBits) { // add status bits and later input values
                    ...
                    case 30:
                        ...
                        // TODO -- make a single expr instead of |'ing ?
                        s9 |= pending[0] << 4;
                        s9 |= pending[1] << 34;
                        consumed = 2;
                        break;
