  ...
  private SimpleOrderedMap<Object> calcFacets() throws IOException {
    ...
    return super.findTopSlots(nTerms, nTerms,
            new IntFunction<Comparable>() {
              @Override
              public Comparable apply(int slotNum) { // getBucketValFromSlotNum
                try {
                  return (Comparable) sf.getType().toObject(sf, FacetFieldProcessorByArray.this.lookupOrd(slotNum + startTermIndex));
                } catch (IOException e) {
