...
public class DelegationTokenResponseTest extends LuceneTestCase {
  ...
  public void testGetResponse() throws Exception {
    ...
    final String someToken = "sometToken";
  ...
  public void testCancelResponse() throws Exception {
    ...
    try {
      delegationTokenResponse(cancelRequest, cancelResponse, "someResponse");
      fail("expected SolrException");
    } catch (SolrException se) {
    }
  }
