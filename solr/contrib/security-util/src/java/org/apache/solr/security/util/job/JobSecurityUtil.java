...
public class JobSecurityUtil {
   ...
   */
  public static void loadCredentialsForClients(JobContext job, String serviceName) throws IOException {
  ...
  throws SolrServerException, IOException {
    ...
    if (job.getConfiguration().getBoolean(USE_SECURE_CREDENTIALS, false)) {
      ...
      DelegationTokenRequest.Cancel cancelToken =
        new DelegationTokenRequest.Cancel(getCredentialsString(job, serviceName));
